...
/**
 * Left-swipe-only delete gesture, split out of SwipeableTaskCard for cards
 * that shouldn't also swipe-to-complete (e.g. routines, which already have
 * their own explicit checkmark button for that).
 */

...
export function EditRecurringTaskSheet({
  ...
  onSave: (
    id: string,
    input: { title: string; category?: string | null; estimated_minutes: number; weekdays?: number[] }
  ) => Promise<void>;
          ...
          >
            ...
            >
              <div className="mb-4 flex items-center justify-between">
                <h2 className="text-lg font-bold">Routine bearbeiten</h2>
                <button
                  onClick={onClose}
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-3">
                ...
                >
                  <Trash2 size={16} />
                  {deleting ? "Wird gelöscht…" : "Routine löschen"}
                </GlowButton>
              </form>
            </motion.div>
          </motion.div>
